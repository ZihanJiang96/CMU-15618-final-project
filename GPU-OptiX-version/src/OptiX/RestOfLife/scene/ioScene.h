...
public:
    ...
    optix::Group CornellBox(optix::Context& context) {
        ...
        ioMaterial *wallBlue = new ioLambertianMaterial(new ioConstantTexture(make_float3(0.25f, 0.25f, 0.75f)));
        ioMaterial *wallRed = new ioLambertianMaterial(new ioConstantTexture(make_float3(0.75f, 0.25f, 0.25f)));
        ioMaterial *wallWhite = new ioLambertianMaterial(new ioConstantTexture(make_float3(0.75f, 0.75f, 0.75f)));
        ...
        materialList.push_back(wallBlue);
